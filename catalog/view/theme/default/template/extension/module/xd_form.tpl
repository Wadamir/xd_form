...
<?php if ($status) { ?>
    <div class="button_wrapper <?= $button_position ?>">
        <a href="javascript:void(0)" onclick="formClickAnalytics?.(); $('#xd_form_modal').modal('show');" id="xd_form_phone_button" class="btn btn-link">
    ...
    <div id="xd_form_modal" class="modal fade <?= $modal_style ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="xd_form-form" action="index.php?route=module/xd_form/send" role="form">
                    <fieldset>
                        <div class="modal-header">
                            ...
                            <h2 id="xd_form_modal_title" class="modal-title"><?php echo $modal_title; ?></h2>
                        </div>
                        <div class="modal-body">
                            <div class="col-xl-12">
                                ...
                                <?php if ($spam_protection) { ?>
                                    <div class="input-group input-group-protected">
                                        ...
                                        <input id="xd_form_email" class="form-control xd_form-input" type="text" name="xd_form_email" placeholder="Email">
                                    </div>
                                <?php } ?>
                                <?php if ($field3_status > 0) { ?>
                                    <div class="form-group<?= ($field3_status === 2) ? ' has-warning' : '' ?>">
                                        <textarea id="xd_form_message" class="form-control xd_form-input<?= ($field3_status === 2) ? ' required' : '' ?>" name="xd_form_message" rows="3" placeholder="<?php echo $field3_title; ?>"></textarea>
                                    </div>
                                <?php } ?>
                        ...
                        <div class="modal-footer">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div id="xd_form_error" class="pb-1 text-left text-danger hidden"></div>
                                </div>
                            </div>
                            <div class="row">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if ($exan_status) { ?>
                sbjs.init();
                formPlaceData(sbjs.get);
            <?php } ?>
        });
        <?php if ($exan_status) { ?>

            function formPlaceData(sb) {
                console.log(sb);
        ...
        function formClickAnalyticsSend() {
        ...
        function formClickAnalyticsSuccess() {
